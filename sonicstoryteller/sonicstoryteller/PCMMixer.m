						 ...
						 numChannels:(NSUInteger)numChannels
{
	...
	audioFormatPtr->mChannelsPerFrame = (unsigned int)numChannels;
	audioFormatPtr->mBytesPerPacket = 2 * (unsigned int)numChannels;
	audioFormatPtr->mFramesPerPacket = 1;
	audioFormatPtr->mBytesPerFrame = 2 * (unsigned int)numChannels;
